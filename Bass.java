...
public class Bass extends StringInstrument {
	...
	// Regular Constructor
	public Bass(double price, String manufacturer, int numberOfStrings, boolean isFretless) {
	...
	public Bass(Scanner s) {
		...
		try {
			...
			throw new InputMismatchException("Whether a bass is fretless or not is boolean, any other "
	...
	public boolean equals(Object anotherObject) {
		...
		if (isFretless != ((Bass) anotherObject).getIsFretless())
			return false;
	...
	public String toString() {
		return super.toString() + "Fretless: " + (isFretless ? "Yes" : "No");
	}
