...
public class StringInstrument extends MusicalInstrument {
	...
	// Regular Constructor
	public StringInstrument(double price, String manufacturer, int numberOfStrings) {
	...
	public StringInstrument(Scanner s) {
		...
		try {
			...
			throw new NoSuchElementException("Corrupted file, " + getClass().getCanonicalName() + " number of strings is missing");
		}
	}
	...
	public boolean equals(Object anotherObject) {
		...
		if (numberOfStrings != ((StringInstrument) anotherObject).getNumberOfStrings())
			return false;
	...
	public String toString() {
		return super.toString() + String.format("Number of strings: %2d|  ", numberOfStrings);
	}
}
